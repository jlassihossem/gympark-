		...
		<main className="classDetails">
			<section>
				...
				<p>
					...
					soluta, a architecto tempora necessitatibus provident eius modi
					temporibus veniam maxime voluptatem aliquam, nihil voluptate
					quibusdam? Repellendus, tempora quod. Inventore ratione cupiditate
					repellendus recusandae accusantium, architecto fugit ad! Nobis ex
					totam animi. Expedita aut ex blanditiis corrupti excepturi beatae
					ullam minus debitis recusandae! Ipsa excepturi vitae in, quaerat
					numquam unde.
				</p>
				<ul>
			...
			<section>
				<div>
					<h2>
						<br />
						<span style={{ color: "#fb5b21 " }}>CLASS</span> SCHEDULE
					</h2>
					<div>
						<div>
							<h4>Monday</h4>
